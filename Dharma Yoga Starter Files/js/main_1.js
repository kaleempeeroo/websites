...
function getMobileMenu() {
    ...
    $('.nav li').each(function() {
        ...
        verticalmenu = verticalmenu + '<li>' + value + '</li>' 
    });
    console.log("hey " + verticalmenu);
	...
	$('.nav').each(function() {
		...
		var $menulist = $(this).children('.nav-menu').html() + "<br><hr>";
        /* get each individual li item from $menulist html 
           add <br><hr>
           concatenate $menulist again 
        */
        //console.log("hey " + $menulist);
		...
		$(this).prepend("<div class='nav-toggled nav-closed'>" + $menucontrols + "<ul>" + verticalmenu + "</ul></div>");
