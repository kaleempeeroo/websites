...
class WooZoneLiteCD_CrawlerDetect
{
    /**
     * The user agent.
     *
    ...
    {
        $this->crawlers = new WooZoneLiteCD_Crawlers();
        $this->exclusions = new WooZoneLiteCD_Exclusions();
        $this->uaHttpHeaders = new WooZoneLiteCD_Headers();
