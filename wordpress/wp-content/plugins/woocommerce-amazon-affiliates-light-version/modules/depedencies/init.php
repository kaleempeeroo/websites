...
if (class_exists('WooZoneLiteDashboard') != true) {
    class WooZoneLiteDashboard
    {
	    ...
	    */
		...
		{
			wp_register_style( 'WooZoneLite-DashboardBoxes', WooZoneLite_asset_path( 'css', $this->module_folder . 'app.depedencies.css', true ), false, WooZoneLite_asset_version( 'css' ) );
        	wp_enqueue_style( 'WooZoneLite-DashboardBoxes' );
		}
		
		public function admin_load_scripts()
		{
			wp_enqueue_script( 'WooZoneLite-DashboardBoxes', WooZoneLite_asset_path( 'js', $this->module_folder . 'app.depedencies.js', true ), array(), WooZoneLite_asset_version( 'js' ), true );
		}
