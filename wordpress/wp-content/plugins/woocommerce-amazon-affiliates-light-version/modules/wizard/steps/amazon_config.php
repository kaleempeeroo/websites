<?php
	...
	$amz_country = $this->WooZoneLite_amazon_countries( 'country' );
	$amz_main_aff_id = $this->WooZoneLite_amazon_countries( 'main_aff_id' );
?>
			<!-- StartSetup -->
			<div class="wz-setup">
				...
				<div class="wz-message">
					...
					<div class="alert alert-danger" role="alert"><?php echo sprintf( __('If you are using the aateam demo keys, you can test out and import up to %d products.', $this->localizationName), $this->the_plugin->ss['max_products_demo_keys'] ); ?>
						<a href="<?php echo admin_url("admin.php?page=WooZoneLite_insane_import"); ?>" target="_blank"><?php _e('Go to Insane Import Module', $this->localizationName); ?></a>
					</div>
				</div>
					...
					<tr>
						...
						<td colspan="2" class="wz-ttext"> 
							...
							<?php echo $this->build_form_input_text('AccessKeyID', array(
								//__('Enter Your Access Key ID', $this->localizationName),
								//'aateam demo access key'
					...
					<tr>
						...
						<td colspan="2" class="wz-ttext"> 
							...
							<?php echo $this->build_form_input_text('SecretAccessKey', array(
								//__('Enter Your Secret Access Key', $this->localizationName),
								//'aateam demo secret access key'
