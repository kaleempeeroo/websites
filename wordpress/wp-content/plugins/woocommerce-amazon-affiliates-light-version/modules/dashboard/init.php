...
if (class_exists('WooZoneLiteDashboard') != true) {
    class WooZoneLiteDashboard
    {
        ...
        */
        ...
        { 
			...
			$this->addBox( 'products_performances', 'Top 
				...
				&nbsp;WZoneLite Products Performances', $this->products_performances(), array(
				'size' => 'grid_4'
			) );
	    ...
	    */
		...
		{
			wp_enqueue_script( 'WooZoneLite-DashboardBoxes', WooZoneLite_asset_path( 'js', $this->module_folder . 'app.dashboard.js', true ), array(), WooZoneLite_asset_version( 'js' ), true );
		}
		...
		public function total_product_views()
		{
			$html = array();
			$html[] = '<div class="WooZoneLite-dynamic-status">';
			$html[] = 	'<h3><span class="WooZoneLite-ds-value-total_hits"></span></h3>';
		...
		public function total_add_cart()
		{
			$html = array();
			$html[] = '<div class="WooZoneLite-dynamic-status">';
			$html[] = 	'<h3><span class="WooZoneLite-ds-value-total_addtocart"></span></h3>';
		...
		public function total_amazon_redirect()
		{
			$html = array();
			$html[] = '<div class="WooZoneLite-dynamic-status">';
			$html[] = 	'<h3><span class="WooZoneLite-ds-value-amazon_redirect"></span></h3>';
