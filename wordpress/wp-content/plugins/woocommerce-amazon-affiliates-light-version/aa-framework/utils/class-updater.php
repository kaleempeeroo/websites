...
if (class_exists('WooZoneLite_AATeam_Product_Updater') != true) {
    class WooZoneLite_AATeam_Product_Updater
    {
        ...
        */
		 ...
		 * @var string
		 */
		public $title = 'WZoneLite - WooCommerce Amazon Affiliates';
        ...
        */
		...
		public function custom_update_style() {
			wp_enqueue_style('aa-updater-style', WooZoneLite_asset_path( 'css', $this->the_plugin->cfg['paths']['freamwork_dir_url'] . 'css/updater.css', true ), array(), WooZoneLite_asset_version( 'css' ) );
		}
