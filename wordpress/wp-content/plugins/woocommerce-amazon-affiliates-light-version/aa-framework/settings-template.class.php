					...
					if(count($box['elements']) > 0){
						...
						foreach ( $box['elements'] as $elm_id => $value ){
							...
							switch ( $value['type'] ) {
								...
								// Basic text_readonly input
								case 'text_readonly':
									$html[] = '<input readonly ' . ( isset($value['force_width']) ? "style='width:" . ( $value['force_width'] ) . "px;'" : '' ) . ' id="' . esc_attr( $elm_id ) . '" name="' . esc_attr( $option_name . $elm_id ) . '" type="text" value="' . esc_attr( $val ) . '" class="' . ( WooZoneLite()->alias ) . '-readonly_select" />';
								...
								case 'translation':
									...
									$html[] = '<div class="' . ( WooZoneLite()->alias ) . '-translation-wrapper">';
								...
								case 'generate_password':
									$html[] = '<input ' . ( isset($value['force_width']) ? "style='width:" . ( $value['force_width'] ) . "px;'" : '' ) . ' id="' . esc_attr( $elm_id ) . '" readonly class="' . ( WooZoneLite()->alias ) . '-readonly_select" name="' . esc_attr( $option_name . $elm_id ) . '" type="text" value="' . esc_attr( $val ) . '" />';
									$html[] = '<a href="#" class="' . ( WooZoneLite()->alias ) . '-generate-password">generate new key</a>';
									$html[] = '<span id="WooZoneLite-direct-import-auth-page"></span>';

									if ( has_site_icon() ) {
										$icon_16 = get_site_icon_url( 16 );
										
										$html[] = '<span id="WooZoneLite-direct-import-favicon" style="display:none">' . ( $icon_16 ) . '</span>';
									}else{

										$html[] = '<span id="WooZoneLite-direct-import-favicon" style="display:none">' . ( get_stylesheet_directory_uri() . '/favicon.ico' ) . '</span>';
									}
									$html[] = '<span id="WooZoneLite-direct-import-site_name" style="display:none">' . ( get_bloginfo( 'name' ) ) . '</span>';
